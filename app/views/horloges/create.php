        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogesController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" min="0" step="0.01" class="form-control" id="prijs" value="<?= $_POST['prijs'] ?? ''; ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" class="form-control" id="gewicht" value="<?= $_POST['gewicht'] ?? ''; ?>" required>
                </div>
